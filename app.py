...
def voice():
    greeting = "Hi, this is kade, your AI receptionist. How can I help you today?"
...
def ask_gpt(prompt):
    try:
        response = openai.chat.completions.create(
            model="gpt-4o",
            messages=[
                {"role": "system", "content": "You are kade, a helpful AI receptionist. Answer clearly and naturally."},
