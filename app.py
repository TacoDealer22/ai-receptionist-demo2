...
STATIC_RESPONSES = {
    ...
    "who made kadi?": "kadi was created by OMAR MAJDI MOHAMMAD ALJALLAD.",
    "what is your name?": "My name is kadi. I’m your AI receptionist.",
...
def voice():
    greeting = "Hi, this is kadi, your AI receptionist. How can I help you today?"
...
def ask_gpt(prompt):
    try:
        response = openai.chat.completions.create(
            model="gpt-4o",
            messages=[
                {"role": "system", "content": "You are kadi, a helpful AI receptionist. Answer clearly and naturally."},
